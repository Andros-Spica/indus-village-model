...
to-report hh_whichMembersDying
  ...
  [
    i ->
    (random-float 1 < get-net-mortality-of-day (item i hh_membersSex) (item i hh_membersAge) densityEffect)
  ] hh_membersIndexes
...
to hh_set-members-to-marry
  ...
  [
    ...
    [
      ...
      if (random-float 1 < get-nuptiality-of-day sex (item i hh_membersAge))  ; passes nuptiality test according to age
      [
        ifelse (sex)
        [
...
to-report hh_get-total-carrying-capacity-demand
  ...
  [
    i ->
    set my-carrying-capacity-demand my-carrying-capacity-demand + (get-carrying-capacity-demand-at-age i)
  ]
