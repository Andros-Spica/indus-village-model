...
to hh_initialise-members
  ...
  [ print (word "WARNING: Initialisation of individual(s) with age in years equal or higher than " (length fertilityTable) " (" age ") detected in " self ": " hh_membersAge ) ]
...
to-report hh_whichMembersDying
  ...
  [
    memberIndex ->
    (random-float 1 < get-net-mortality (item memberIndex hh_membersSex) (item memberIndex hh_membersAge) densityEffect)
  ] hh_membersIndexes
...
to export-households
  ...
  let FilePath "analysis//simdata//v1.2.2//hh//"
