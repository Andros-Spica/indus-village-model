...
Create filter for Indus crops:

```{r}
indusCrops <- c(" 'wheat 1'", " 'wheat 2'", " 'rice'", " 'dry bean'", " 'greenbean'")

isIndusCrop <- yieldData$crop == " 'wheat 1'" | yieldData$crop == " 'wheat 2'" | yieldData$crop == " 'rice'" | yieldData$crop == " 'dry bean'" | yieldData$crop == " 'greenbean'"
```

Apply filter (optional):

```{r}
yieldData <- yieldData[isIndusCrop,]
...
```{r}
plotName = "plots/SIMPLE-crop-model/yieldPerCrop_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/yield_scaledPerCrop_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/ARIDvsPrecipitation_yearlyMean_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/ARIDvsPrecipitation_dailyCum_plateauValue_yearlyMean_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/yieldVsARID_indus.png"
...
legend(x = 0, y = 1, 
       legend = stringi::stri_c(cropTable$S_water[cropTable$crop %in% indusCrops], " (", levels(yieldData$crop), ")"), 
       title = "S_water (Crop-cultivar)", 
       fill = cropColours)
...
```{r}
plotName = "plots/SIMPLE-crop-model/yieldVsARID_scaled_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/yieldVsprecipitation_yearlyMean_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/yield_scaledByCropVsprecipitation_yearlyMean_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/yieldVsprecipitation_dailyCum_plateauValue_yearlyMean_indus.png"
...
```{r}
plotName = "plots/SIMPLE-crop-model/yield_scaledByCropVsprecipitation_dailyCum_plateauValue_yearlyMean_indus.png"
